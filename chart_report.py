...
def david_enrich(list_file,
    ...
    print('User Authentication:', client.service.authenticate(USER))
    ...
    print('Use categories:', client.service.setCategories(category))
    chart_report = client.service.getTermClusterReport(3,2,2,0.5,30)
    print('Total chart records:', len(chart_report))
    print(chart_report)
...
if __name__ == '__main__':
    david_enrich(list_file='./list1.txt',
                 id_type='AFFYMETRIX_3PRIME_IVT_ID',
                 list_name='list1',category='abcd,BBID,BIOCARTA,COG_ONTOLOGY,INTERPRO,KEGG_PATHWAY,OMIM_DISEASE,PIR_SUPERFAMILY,SMART,SP_PIR_KEYWORDS,UP_SEQ_FEATURE')
